...
void ApplyLayerNorm(const int16_t *input, const int16_t *layer_norm_weights,
  ...
  RISCV_OR_PORTABLE(ApplyLayerNorm, input, layer_norm_weights, bias,
...
void CwiseMul(const int16_t *input_1, const int16_t *input_2, int n_batch,
  ...
  RISCV_OR_PORTABLE(CwiseMul, input_1, input_2, n_batch, n_input, shift,
                    output);
}
...
float VectorVectorDotProduct(const float *vector1, const float *vector2,
                             int v_size) {
  return RISCV_OR_PORTABLE(VectorVectorDotProduct, vector1, vector2, v_size);
}
...
void VectorScalarMultiply(const int8_t *vector, int v_size, float scale,
                          float *result) {
  RISCV_OR_PORTABLE(VectorScalarMultiply, vector, v_size, scale, result);
}
