...
==============================================================================*/
#ifndef TENSORFLOW_LITE_KERNELS_INTERNAL_OPTIMIZED_RISCV_TENSOR_UTILS_H_
#define TENSORFLOW_LITE_KERNELS_INTERNAL_OPTIMIZED_RISCV_TENSOR_UTILS_H_
...
void SparseMatrixBatchVectorMultiplyAccumulate1x4(
  ...
  RISCV_OR_PORTABLE(SparseMatrixBatchVectorMultiplyAccumulate1x4, matrix,
...
void ApplyLayerNorm(const int16_t* input, const int16_t* layer_norm_weights,
  ...
  PORTABLE_RISCV(ApplyLayerNorm, input, layer_norm_weights, bias,
...
void ApplySigmoid(const int16_t* input, int32_t n_batch, int32_t n_input,
                  int16_t* output) {
  PORTABLE_RISCV(ApplySigmoid, input, n_batch, n_input, output);
}
...
void ApplyTanh(int32_t integer_bits, const int16_t* input, int32_t n_batch,
  ...
  PORTABLE_RISCV(ApplyTanh, integer_bits, input, n_batch, n_input, output);
}
...
void CwiseMul(const int16_t* input_1, const int16_t* input_2, int n_batch,
  ...
  RISCV_OR_PORTABLE(CwiseMul, input_1, input_2, n_batch, n_input, shift, output);
}
...
void CwiseMul(const int16_t* input_1, const int16_t* input_2,
  ...
  RISCV_OR_PORTABLE(CwiseMul, input_1, input_2, multiplier, shift, n_batch,
...
void VectorBatchVectorCwiseProductAccumulate(const int16_t* vector, int v_size,
  ...
  PORTABLE_RISCV(VectorBatchVectorCwiseProductAccumulate, vector, v_size,
                   batch_vector, n_batch, multiplier, shift, result);
}

float VectorVectorDotProduct(const float* vector1, const float* vector2,
                             int v_size) {
  return PORTABLE_RISCV(VectorVectorDotProduct, vector1, vector2, v_size);
}
...
void VectorScalarMultiply(const int8_t* vector, int v_size, float scale,
                          float* result) {
  PORTABLE_RISCV(VectorScalarMultiply, vector, v_size, scale, result);
}
...
void AsymmetricQuantizeFloats(const float* values, const int size,
                              ...
                              int32_t* offset) {
  PORTABLE_RISCV(AsymmetricQuantizeFloats, values, size, quantized_values,
...
#endif  // TENSORFLOW_LITE_KERNELS_INTERNAL_OPTIMIZED_RISCV_TENSOR_UTILS_H_
